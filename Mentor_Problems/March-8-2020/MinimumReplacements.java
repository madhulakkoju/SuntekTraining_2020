...
//------------------------->>>> MUCH OPTIMIZED APPROACH has to be tried for. 
...
// the Method minReplacementwithDp() is similar to Bruteforce but optimized using storing already calculated values so that repeated trees are pruned away to reduce time taken.
